...
class TripalCultivatePhenotypesTraitsImporter extends ChadoImporterBase implements ContainerFactoryPluginInterface {
  ...
  public function form($form, &$form_state) {
    ...
    // Test validation result array.
    ////////
    $validation_result = [
      [
        'title' => 'Validation Title - failed validator #1',
        'status' => 'pass',
        'details' => []
      ],
      [
        'title' => 'Validation Title - failed validator #2',
        'status' => 'pass',
        'details' => []
      ],
      [
        'title' => 'Validation Title - failed validator #3',
        'status' => 'fail',
        'details' => [
          '#type' => 'item',
        ...
        'details' => [
          ...
          'failed_items' => [
            ...
            '#items' => [
              ...
              'Failed Item Value #8',
              'Failed Item Value #9',
              'Failed Item Value #10'
            ],
          ]
        ]
      ],
      [
        'title' => 'Validation Title - failed validator #4',
        'status' => 'fail',
        'details' => [
          '#type' => 'html_tag',
          '#tag' => 'ul',
    ...
    // Send validation result array to feedback engine.
    $form['validation_result'] = [
      '#type' => 'inline_template',
      '#theme' => 'result_window',
      '#data' => [
